  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-4 bg-gray-950">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {images.map((img, index) => (
            <div 
              ...
              className="group relative aspect-video overflow-hidden rounded-2xl border-2 border-purple-900/30 cursor-pointer bg-gray-900"
            >
              <img 
                src={img.url} 
                alt={img.title}
      ...
      {selectedImage && (
        ...
        >
          <button 
            className="absolute top-10 right-10 text-white text-4xl hover:text-yellow-500 transition-colors z-[210]"
            onClick={() => setSelectedImage(null)}
          >
